...
class TestRange(unittest.TestCase):
    ...
    def test_init(self):
        a = k3rangeset.Range(1, 2)
        dd(a)
        a = k3rangeset.Range(1, 1)
        dd(a)
    ...
    def test_is_adjacent(self):
        ...
        for a, b, expected in cases:
            ...
            a = k3rangeset.Range(*a)
            b = k3rangeset.Range(*b)
    ...
    def test_substract(self):
        ...
        for a, b, expected in cases:
            ...
            # test module method
            rst = k3rangeset.substract_range(a, b)
            dd('rst:', rst)
    ...
    def test_intersect(self):
        ...
        for a, b, expected in cases:
            ...
            self.assertEqual(expected, a.intersect(k3rangeset.Range(*b)))
            self.assertEqual(expected, a.intersect(k3rangeset.ValueRange(*(b+['bar']))))
    ...
    def test_length(self):
        ...
        for rng, expected in cases:
            ...
            rst = k3rangeset.Range(*rng).length()
            dd('rst:', rst)
    ...
    def test_unicode(self):
        ...
        for rng in cases:
            self.assertRaises(ValueError, k3rangeset.ValueRange, *rng)
    ...
    def test_bytes(self):
        ...
        for l, r, v in cases:
            self.assertRaises(TypeError, k3rangeset.ValueRange, l, r, v)
            self.assertRaises(TypeError, k3rangeset.ValueRange, r, l, v)
...
class TestRangeSet(unittest.TestCase):
    ...
    def test_invalid_element_type(self):
        ...
        for typ in cases:
            ...
            k3rangeset.Range(typ(), typ())
            k3rangeset.RangeSet([[typ(), typ()]])
        ...
        for val in cases:
            ...
            self.assertRaises(TypeError, k3rangeset.Range, [val, val])

            self.assertRaises(TypeError, k3rangeset.RangeSet, [[val, val]])

        # incompatible type
        self.assertRaises(TypeError, k3rangeset.Range, 1, 'a')

    def test_range_left_le_right(self):
        self.assertRaises(ValueError, k3rangeset.Range, 1, 0)
    ...
    def test_rangeset_has(self):
        ...
        rs = k3rangeset.RangeSet([[None, 1], [10, 20], [30, 40], [50, None]])
        cases = (
            (-1, True),
            (0, True),
            (1, False),
    ...
    def test_union(self):
        ...
        for a, b, expected in cases:
            ...
            a = k3rangeset.RangeSet(a)
            b = k3rangeset.RangeSet(b)

            rst = k3rangeset.union(a, b)
    ...
    def test_length(self):
        rst = k3rangeset.RangeSet([[1, 2], [5, 8]]).length()
        self.assertEqual(4, rst)

        rst = k3rangeset.RangeSet([['a', 'b'], ['d', 'd\0']]).length()
...
class TestIntIncRangeSet(unittest.TestCase):
    ...
    def test_int_inc_substract(self):
        ...
        for a, b, expected in cases:
            ...
            a = k3rangeset.RangeSet(a, range_clz=k3rangeset.IntIncRange)
            b = k3rangeset.RangeSet(b, range_clz=k3rangeset.IntIncRange)
    ...
    def test_int_inc_length(self):
        ...
        rst = k3rangeset.IntIncRangeSet([[1, 2], [5, 8]]).length()
        self.assertEqual(6, rst)

    def test_inherit_range_clz(self):

        a = k3rangeset.IntIncRangeSet([[1, 2]])
        b = k3rangeset.IntIncRangeSet([[2, 3], [5, 6]])

        cases = (
            k3rangeset.union,
            k3rangeset.substract,
            k3rangeset.intersect,
        )
...
class TestRangeDict(unittest.TestCase):
    ...
    def test_init(self):
        ...
        rd = k3rangeset.RangeDict([(1, 2, '12'), [3, 4, '34']])
    ...
    def test_adjacent_elts(self):
        ...
        rd = k3rangeset.RangeDict([(1, 2, '12'), [2, 3, '23']])
    ...
    def test_get_min(self):
        ...
        for src_rngs, expected in cases:
            ...
            dd("expected range: ", k3rangeset.ValueRange(*expected[1]))
            dd("expected value: ", expected[2])

            rd = k3rangeset.RangeDict(src_rngs)
            ...
            self.assertEqual(rng, k3rangeset.ValueRange(*expected[1]))
            self.assertEqual(val, expected[2])

        rd = k3rangeset.RangeDict()
    ...
    def test_add(self):
        ...
        for a, expected in cases:
            rd = k3rangeset.RangeDict([(1, 5, '15'), [7, 9, '79']])
            dd('init:', rd)
            dd('add:', a)
    ...
    def test_intersect(self):
        ...
        a = k3rangeset.RangeDict([[1, 3, 'a'], [5, 10, 'b']])
        b = k3rangeset.RangeDict([[2, 8, 'x']])

        self.assertEqual([[2, 3, 'a'], [5, 8, 'b']], k3rangeset.intersect(a, b))
    ...
    def test_find_overlapped(self):
        ...
        for a, b, expected in cases:
            ...
            self.assertEqual(expected, a.find_overlapped(k3rangeset.Range(*b)))
            self.assertEqual(expected, a.find_overlapped(k3rangeset.ValueRange(*(b+['bar']))))

            a = k3rangeset.RangeSet([x[:2] for x in a])
...
class TestRangeDictMultiDimension(unittest.TestCase):
    ...
    def test_get(self):
        ...
        r = k3rangeset.RangeDict(self.inp, dimension=2)
    ...
    def test_substract(self):
        r = k3rangeset.RangeDict(self.inp, dimension=2)
        r = k3rangeset.substract(r, k3rangeset.RangeDict([[0.5, 1.5, None]]))
        dd(r)
        ...
        r = k3rangeset.substract(r, k3rangeset.RangeDict([[0, 1.5, None]]))
        dd(r)
